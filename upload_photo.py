...
Example:
    python3 upload_photo.py ~/Pictures/sunset.jpg --date 2026-04-12 --location "Yosemite National Park" --caption "Half Dome"
"""
...
def repo_root() -> Path:
    ...
    if (p / "photos.json").is_file():
        return p
    sys.exit("Run this from the portfolio repo (photos.json next to upload_photo.py).")
